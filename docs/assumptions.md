...
| 5 | Budget diesel price for variance model (Q3) | FINAL: 1.389 EUR/l with tax = 2021 DE annual mean (pre-shock base year), sourced from a budget_2021 CTE | Method: annual mean DE diesel price for 2021 from the Oil Bulletin, held fixed as the budget. Used in q3_diesel_variance.sql | 2026-07-22 |
